...
> Replaces: WeTransfer Business ($120/user/year), AWS S3 Transfer ($0.09/GB), Dropbox Transfer.
> PeerVault transfers files directly browser-to-browser with AES-256-GCM encryption. Zero server storage.

## Pricing

| Tier | Price | What You Get |
|:-----|:------|:-------------|
| **Indie** | $199/year | 1 developer, 1 application |
| **Startup** | $1,499/year | Up to 15 developers, 3 applications |
| **Enterprise** | $7,999/year | Unlimited developers, unlimited apps, priority support |
| **Platform / OEM** | $14,999/year | White-label rights, embed in your product |
| **Full IP Buyout** | $500,000 | Complete intellectual property transfer |

### Why This Pricing?

A company transferring 10TB/month via cloud storage:
- **AWS S3 Transfer**: ~$900/month ($10,800/year)
- **WeTransfer Business** (100 users): $12,000/year
- **PeerVault Enterprise**: $7,999/**year** (saving $3K–$5K/year + zero data exposure)
